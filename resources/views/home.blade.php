...
@section('content')
            ...
            <section class="hero-header bg-dark text-white"style = "margin-top: -25px">
                <div class="container py-5" > 
                    <div class="row align-items-center g-5" >
                        <div class="col-12 col-lg-6 text-center text-lg-start">
                            <h1 class="display-4 fw-bold mb-3">Enjoy Our<br>Delicious Meal</h1>
                            <p class="lead mb-4">
                                Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos.
                                Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet.
                            </p>
                            <a href="#reservation" class="btn btn-primary btn-lg px-4">Book A Table</a>
                        </div>
                        <div class="col-12 col-lg-6 text-center">
                            <div class="hero-art mx-auto">
                                <img class="img-fluid hero-spin" src="{{ asset('assets/img/hero.png') }}" alt="Hero">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-2" class="tab-pane fade show p-0">
                            <div class="row g-4">
                                    @foreach ($lunchFoods as $lunchFood)
                                        <div class="col-lg-6">
                                            <div class="d-flex align-items-center">
                                                <img class="flex-shrink-0 img-fluid rounded" src="{{ asset('assets/img/'.$lunchFood->image) }}" alt="" style="width: 80px;">
                                                <div class="w-100 d-flex flex-column text-start ps-4">
                                                    <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                        <span>{{ $lunchFood->name }}</span>
                                                        <span class="text-primary">${{ $lunchFood->price }}</span>
                                                    </h5>
                                                    <small class="fst-italic">{{substr($lunchFood->description, 0, 100)}}</small>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                    ...
                                                    <small class="fst-italic">{{substr($dinnerFood->description, 0, 100)}}</small>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <input name="date" type="text" class="form-control datetimepicker-input" id="datetime" placeholder="Date & Time" data-target="#date3" data-toggle="datetimepicker" />
                                        @error('date')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror

...
<head>
    ...
    <!-- In <head> (optional if you already load CSS via Vite) -->
...
<body>
    <div id="app">
        ...
        <div class="container-fluid px-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0 navbar-smooth">
                                ...
                                <<li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 rounded-3" aria-labelledby="navbarDropdown">
                                        <li>
                                            ...
                                            href="{{ route('food.booking.history') }}"> 
